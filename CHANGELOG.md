...
- Complete Turkish translation: the 272 keys that were still missing from `turkish.yaml` (dictionary, bookmarks & clippings, keyboard hints, nearby transfer, KOReader sync errors, firmware update, reading-stats screens, date formats) plus 8 values that had been left in English.
